...
AProjectile::AProjectile()
{
	...
	ProjMoveComp = CreateDefaultSubobject<UProjectileMovementComponent>(TEXT("Projectile Movement Comp"));
	ProjMoveComp->MaxSpeed = 1300.0f;
	ProjMoveComp->InitialSpeed = 1300.0f;
